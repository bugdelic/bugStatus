    ...
    public class DynamicCharacter 
    {
        ...
        public void Update ()
        {
            if (this.Movement != null) 
            {
				...
				Debug.DrawRay(this.KinematicData.position, MathHelper.ConvertOrientationToVector(this.KinematicData.orientation + (MathConstants.MATH_PI-MathConstants.MATH_PI_4)) * 5f, Color.magenta);
				Debug.DrawRay(this.KinematicData.position, MathHelper.ConvertOrientationToVector(this.KinematicData.orientation - (MathConstants.MATH_PI - MathConstants.MATH_PI_4)) * 5f, Color.magenta);
